...
void selinux_android_set_policy_index(void)
{
	...
	if (memcmp(map_base, map_override, sizeof &map_base) == 0)
		policy_index = 1;
...
out:
	selinux_log(SELINUX_INFO, "SELinux: Using %s policy\n", (policy_index == 0) ? "base" : "/data");
}
